            ...
            <Col sm={9}>
              <Tab.Content>
                <Tab.Pane eventKey="first">
                  <h4>
                    <span className="text-light-emphasis fw-normal">
                      Name:{" "}
                    </span>
                    {client.name}
                  </h4>
                  ...
                  <h4>
                    ...
                    {client.mark} /{" "}
                    {client.withPump ? "With Pump" : "Without Pump"} /{" "}
                    {client.installed
                      ? "Company Installations"
                      : "Not Company Installations"}
                  </h4>
                  <h4>
                    <span className="text-light-emphasis fw-normal">
                      Installation Date:{" "}
                    </span>
                    {new Date(client.instDate).toLocaleDateString()}
                  </h4>
                  <h4>
                    <span className="text-light-emphasis fw-normal">
                      Maintenance Date:{" "}
                    </span>
                    {new Date(client.maintDate).toLocaleDateString()}
                  </h4>
                  <h4>
                    <span className="text-light-emphasis fw-normal">
                      Comments:{" "}
                  ...
                  <h4>
                    <span className="text-light-emphasis fw-normal">TDS: </span>
                  </h4>
                  <ProgressBar
                    now={client.tds * 0.111}
                    label={`${client.tds} PPM`}
                  />
                </Tab.Pane>
                <Tab.Pane eventKey="second">
                  Coming Soon. We are working on some awesome things you can
